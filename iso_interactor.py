...
def add_val_in_ColorTransfertFunction(new_value, color_func_proxy):
    ...
    for i in range(int(len(color_func_proxy.RGBPoints)/4)) :
        color_func.AddRGBPoint(color_func_proxy.RGBPoints[(i*4)],
...
def left_button_press_event(arg1, arg2):
    ...
    add_val_in_ColorTransfertFunction(new_value, color_func_proxy)
